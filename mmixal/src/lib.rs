...
fn extract_label(line: &str) -> (Option<&str>, &str) {
    // Label is a word at the start of the line that doesn't start with whitespace
    // and is followed by whitespace or nothing, and the first char is alphabetic/underscore
